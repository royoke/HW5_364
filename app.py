...
app.config["SQLALCHEMY_DATABASE_URI"] = "postgresql://localhost/royokeHW5"
## Provided:
...
class UpdateInfoForm(FlaskForm):
    new_priority = IntegerField('What is the new priority of this todolist item', validators=[Required()])
    submit = SubmitField('Update')
...
def update(item):
    ...
    if form.validate_on_submit():
        ...
        s = TodoItem.query.filter_by(description=item).first()
